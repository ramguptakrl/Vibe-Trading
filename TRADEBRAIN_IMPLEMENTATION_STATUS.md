...
- Working branch: `tradebrain-phase8-mtf-costs` (legacy branch name; Phase 8 scope was revised to DAY/SWING-first)
...
- Combined Phase 7 + revised Phase 8 isolated validation: **52 passed**
...
- [x] Resident and NRI Non-PIS brokerage are fee-estimation profiles, not advice-eligibility gates.
